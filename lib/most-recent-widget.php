...
class _themename_Most_Recent_Widget extends WP_Widget {
    ...
    public function __construct() {
        parent::__construct(
            '_themename_mst_recent_widget',             // widget id
            esc_html__('Recent Posts', '_themename'),   // Name will show in the admin
            array(
                'description' => esc_html__('some description', '_themename'),  //Description
